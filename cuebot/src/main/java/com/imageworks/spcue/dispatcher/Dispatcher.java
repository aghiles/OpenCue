...
public interface Dispatcher {
     ...
     * collected as (frame, proc) pairs for the Scheduler to commit in bulk. No DB access and no
     * RQD launch; the plan stops at the first frame the host cannot hold.
     */
