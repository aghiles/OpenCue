...
public final class SchedulerCompletionQueue {
    ...
    /**
     * Ack-path enqueue. Never blocks, never throws; over the cap it returns false so the CALLER
     * can refuse the report with the retry signal BEFORE acking it. RQD then holds the report and
