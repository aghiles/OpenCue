 ...
 * host alone (its totals, its idle resources, the layers planned on it this tick, the frames
 * each layer holds on it and the warmth claims of the waiting layers on it), a fact of the
 * candidate alone, or one of three facts that name both:
