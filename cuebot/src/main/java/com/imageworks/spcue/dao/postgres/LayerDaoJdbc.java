...
public class LayerDaoJdbc extends JdbcDaoSupport implements LayerDao {
     ...
     * whole batch of completions instead of three or four per frame. Row shapes: success
     * {coreTime, gpuTime, clockTime, pk_layer}, high and low {clockTime, pk_layer, clockTime},
     * fail {coreTime, clockTime, pk_layer}.
     */
    @Override
