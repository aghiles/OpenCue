...
public class JobDaoJdbc extends JdbcDaoSupport implements JobDao {
     ...
     * whole batch of completions instead of two or three per frame. Row shapes: success
     * {coreTime, gpuTime, clockTime, pk_job}, high {clockTime, pk_job, clockTime}, fail
     * {coreTime, clockTime, pk_job}.
     */
    @Override
