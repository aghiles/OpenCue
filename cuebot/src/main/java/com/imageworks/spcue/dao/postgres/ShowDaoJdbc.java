...
public class ShowDaoJdbc extends JdbcDaoSupport implements ShowDao {
    ...
    /**
     * The batched form of updateFrameCounters: the same one-row increments, one JDBC round trip
     * per outcome for a whole batch of completions instead of one per frame. Rows are {pk_show}.
     */
    @Override
